...
function DetailsProductPage(props) {
	...
	const handleAddToCart = () => {
		...
		if (!counter || !priceItem || !size) {
			toast.error("Select Size and Total Item First");
		} else {
			const setData = {
				product_id: props.data.id,
				quantity: counter,
				name: props.data.nameProduct,
				price: priceItem * counter,
				size: size,
				image: props.data.image,
			};
				...
				<div className="container d-flex justify-content-center mt-5 col-12">
					<div className="row col-12">
						...
						<div className="col-lg-6 col-12">
							...
							{/* <div className="product-details__product-desc mt-4 fw-400 fs-25 text-poppins"></div> */}
							...
							<div className="d-flex justify-content-between mt-5 mb-4">
								...
								<div className="product-details__price fw-700 fs-35 fs-sm-25">
									IDR {formatIDR(priceItem * counter)}
								</div>
							</div>
